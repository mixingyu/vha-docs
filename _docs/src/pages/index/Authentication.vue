<template>
  <div class="index_PG-Authentication">
<!-- ------------------------------------------- -->
...
<!-- ------------------------------------------- -->
    <section id="lastSection" class="_df _jcsb">
      <a href="https://github.com/neoStudioGroup/vha-native/blob/master/_docs/src/pages/_data/Authentication.md" target="_blank">在 GitHub 上编辑此页</a>
